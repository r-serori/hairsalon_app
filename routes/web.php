...
Route::middleware('auth:sanctum')->group(function () {
    Route::middleware('web')->group(function () {
        ...
        Route::prefix('/{user_id}')->group(function () {
            ...
            Route::get('/images/selectedAttendanceTimes/{yearMonth}', [AttendanceTimesController::class, 'selectedAttendanceTime']);
            //クエリのuser:idを受け取り、そのユーザーの一番新しい勤怠時間を取得　Gate,ALL   
            Route::get('/firstAttendanceTimes/firstGet', [AttendanceTimesController::class, 'firstAttendanceTime']);
            ...
            //コース情報のコントローラー post,update,destroy = Gate,OWNER,MANAGER   , index = Gate,ALL
            Route::get('/merchandises', [MerchandisesController::class, 'index']);
            ...
            //コース情報のコントローラー post,update,destroy = Gate,OWNER,MANAGER   , index = Gate,ALL
            Route::get('/hairstyles', [HairstylesController::class, 'index']);
            ...
            Route::get('/daily_sales', [DailySalesController::class, 'index']);
            ...
            //コース情報のコントローラー post,update,destroy = Gate,OWNER,MANAGER   
            Route::get('monthly_sales', [MonthlySalesController::class, 'index']);
            ...
            //コース情報のコントローラー post,update,destroy = Gate,OWNER,MANAGER   
            Route::get('/yearly_sales', [YearlySalesController::class, 'index']);
            ...
            //コース情報のコントローラー post,update,destroy = Gate,OWNER,MANAGER   , index = Gate,ALL;
            Route::get('/stock_categories', [StockCategoriesController::class, 'index']);
