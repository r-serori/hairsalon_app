<x-app-layout>
  ...
  <div class="container mx-auto py-6">
    <div class="w-full max-w-md mx-auto">
      <form action="{{ route('yearly_sales.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="yearly_sales" name="yearly_sales" id="yearly_sales" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="売り上げを入力してください">
          @error('yearly_sales')
          <p class="text-red-500 text-xs italic">{{ $message }}</p>
          @enderror
        </div>
