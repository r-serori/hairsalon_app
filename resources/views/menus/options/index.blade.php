...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('options.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                新規作成
            </a>
        </div>
    </x-slot>
    ...
    <div class="flex justify-end mb-4">
        <form action="{{ route('options.index') }}" method="GET" class="flex">
        ...
        <a href="{{ route('options.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
            全体表示
        </a>
    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="{{ route('options.show', $option->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">詳細</a>
